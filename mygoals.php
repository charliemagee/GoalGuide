...
?>
    ...
    <div id="content">
        <div id="main" class="columnfull" role="main">
            ...
            <div id="goalcontent">
                <!--                <a href="#createModal" role="button" id="teeth" data-toggle="modal"><div id="teethclick"></div></a>-->
                <!--                <a href="#createModal" role="button" id="reading" data-toggle="modal"><div id="readingclick"></div></a>-->
                <ul id="listheader">
            ...
            <div class="control-group">
                ...
                <div id="theincentivepic" class="controls uncheckit">
                    <ul class="incentive">
                        ...
                        <li>
                            <label class="radio">
                                <input type="radio" name="incentivepic" value="images/foreworks.jpg"><img src="images/fireworks-sm.jpg" class="thumbnail">
                            </label>
                        </li>
                        <li>
                            <label class="radio">
