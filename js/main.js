...
var capfirstname, chart1, checkinginfotype, congratulations, createDayToday, createGuid, createInfoDate, currentDate, currentDay, data, dataDate, dateString, datecreated, dayToday, daysOfWeek, daysOfWeekA, daysOfWeekB, daysOfWeekC, deadline, displayMyGoalList, displayUserList, displayprimaryGoals, emailCompletion, emailGoal, firstname, future, futureDate, getDate, goal, goalCategory, goalChange, goalTitle, goalType, goalguid, goalinfo, goalmessage, goals, incentivepic, incentivetext, index, infocreated, init, makeNewUser, makeSampleGoals, mygoaldate, myinfo, mytitle, newcreated, newgoal, newinfo, newinfocreated, newprimarygoal, notify, placeincentivetext, primarygoalChange, primarygoals, resetCompleted, setDate, showCongrats, showThatGoalList, showUserList, updateGoal, updateStatus, user, userListChange, userguid, username, users;
