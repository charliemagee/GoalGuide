...
var chart1, checkinginfotype, congratulations, createDayToday, createGuid, createInfoDate, currentDate, currentDay, data, dataDate, dateString, datecreated, dayToday, daysOfWeek, daysOfWeekA, daysOfWeekB, daysOfWeekC, deadline, displayMyGoalList, displayUserList, displayprimaryGoals, emailCompletion, emailGoal, findAndRemove, findAndRemoveUserGoals, firstname, future, futureDate, getDate, goal, goalCategory, goalChange, goalTitle, goalType, goalguid, goalinfo, goalmessage, goals, incentivepic, incentivetext, index, infocreated, init, logSummary, makeNewUser, makeSampleGoals, mygoaldate, myinfo, mytitle, newcreated, newgoal, newinfo, newinfocreated, newprimarygoal, notify, placeincentivetext, primarygoalChange, primarygoals, resetCompleted, setDate, showCongrats, showThatGoalList, showUserList, updateGoal, updateStatus, userguid, username;
...
showCongrats = function() {
  ...
  return setTimeout("$('.congratsmessage').hide();", 5000);
};
...
emailCompletion = function() {
  ...
  return console.log(username + goalmessage + ' has been sent to ' + notify);
};
